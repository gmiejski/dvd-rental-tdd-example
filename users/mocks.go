...
func (f *facadeStub) Add(user CreateUser) (CreatedUserDTO, error) {
	panic("implement me")
}

func (f *facadeStub) Get(userID int) (UserDTO, error) {
...
func NewFacadeStub(stubbedUsers []UserDTO) UsersFacade {
